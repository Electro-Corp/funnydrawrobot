...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0, 13.2);
    ...
    public static double GEAR_RATIO = 0.4917; // (0.5) output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 14.78; // (13.6) in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(135.4727);
